...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {realpathSync} from 'fs'
...
function getRealpath (n) {
  try {
    return realpathSync(n) || <span class="branch-1 cbranch-no" title="branch not covered" >n</span>
  } catch (e) {
...
function shouldSkip (file) {
  if (!exclude) {
    exclude = testExclude({
      cwd: process.env.NYC_CWD || <span class="branch-1 cbranch-no" title="branch not covered" >getRealpath(process.cwd()),</span>
      configKey: 'nyc',
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jul 08 2016 23:48:39 GMT-0700 (PDT)
</div>
</div>
